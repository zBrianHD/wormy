...
def appleGravity(coord): ###########FIXXXX##########
    coord['y'] += 1
    if coord['y'] >= CELLHEIGHT:
        coord = getRandomLocation()
...
def getRandomLocation():
    return {'x': random.randint(0, CELLWIDTH - 1), 'y': 1} #random.randint(0, CELLHEIGHT - 1)
